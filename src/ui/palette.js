...
// NEUTRAL medium-dark grays — the chrome is a true-neutral ground so the ORANGE accent
// + the category colours pop. Tint weights stay 0 (no accent bleed on chrome).
const SURFACES = [
...
// Text anchors (dark), neutral. Light mirrors them luminance-inverted; contrast mixes
// toward the surface extreme (black in dark, white in light) in the same slider direction.
