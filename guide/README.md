...
5. [Fixtures & the Library](05-fixtures-and-inventory.md) — defining light shapes, templates, and patching.
...
- **Template** = a reusable definition you stamp fixtures/devices from (kept in the Library).
