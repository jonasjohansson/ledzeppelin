...
test('registry contains the expected generators and effects', () => {
  assert.deepEqual(generatorNames().sort(), ['audiobars', 'aurora', 'axisgradient', 'bodywave', 'breathe', 'candle', 'caustics', 'chase', 'checkers', 'colortwinkles', 'colorwaves', 'colorwipe', 'comet', 'domainwarp', 'fire2012', 'fireflicker', 'flowfield', 'glitter', 'gradient', 'grid', 'larson', 'lightning', 'line', 'matrix', 'metaballs', 'noise', 'noise3d', 'pacifica', 'planepulse', 'planesweep', 'plasma', 'pride', 'pulse', 'radial', 'rainbow', 'rainbowcycle', 'ripple', 'running', 'shockburst', 'sine', 'sinelon', 'sinewave', 'solid', 'sparkle', 'spectrum', 'spherepulse', 'starfield', 'theater', 'tunnel', 'twinkle', 'twinklefox']);
